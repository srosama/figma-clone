...
export default function Navbar({ activeElement, handleActiveElement }: NavbarProps) {
    ...
    return (
        <nav className="flex select-none items-center justify-between gap-4 w-full bg-backgroundDash text-white">
